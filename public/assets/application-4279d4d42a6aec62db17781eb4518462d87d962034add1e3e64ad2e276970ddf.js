...
(function() {
  $(document).on('page:change', function() {
    var loading_dishes, loading_foodventures, loading_pages;
    if ($('#dishes-paginate').size() > 0) {
      $('#dishes-paginate .pagination').hide();
      loading_dishes = false;
      $('#more-dishes').show().click(function() {
        var $this, more_dishes_url;
        if (!loading_dishes) {
          loading_dishes = true;
          ...
          $.getScript(more_dishes_url, function() {
            if ($this) {
              $this.text('MORE DISHES').removeClass('disabled');
            }
            return loading_dishes = false;
          });
        }
      });
    }
    if ($('#foodventures-paginate').size() > 0) {
      ...
      $('#more-foodventures').show().click(function() {
        var $this, more_foodventures_url;
        if (!loading_foodventures) {
          loading_foodventures = true;
          more_foodventures_url = $('#foodventures-paginate .pagination .next_page a').attr('href');
          $this = $(this);
          $this.html('<img src="/assets/ajax-loader.gif" alt="Loading..." title="Loading..." />').addClass('disabled');
          $.getScript(more_foodventures_url, function() {
            if ($this) {
              $this.text('MORE FOODVENTURES').removeClass('disabled');
            }
            return loading_foodventures = false;
          });
        }
      });
    }
    if ($('#pages-paginate').size() > 0) {
      ...
      loading_pages = false;
      return $('#more-pages').show().click(function() {
        var $this, more_pages_url;
        if (!loading_pages) {
          loading_pages = true;
          more_pages_url = $('#pages-paginate .pagination .next_page a').attr('href');
          $this = $(this);
          $this.html('<img src="/assets/ajax-loader.gif" alt="Loading..." title="Loading..." />').addClass('disabled');
          $.getScript(more_pages_url, function() {
            if ($this) {
              $this.text('MORE PAGES').removeClass('disabled');
            }
            return loading_pages = false;
          });
        }
      });
    }
